    ...
    <div className="min-h-screen p-6 md:p-12 max-w-7xl mx-auto space-y-8">
      <header className="flex justify-between items-center pb-6 border-b border-border">
        <div>
          ...
          <p className="text-gray-400">Generated by MF Portfolio X-Ray Multi-Agent System</p>
        </div>
        <button onClick={onReset} className="px-4 py-2 bg-surface text-sm font-medium border border-border rounded-lg hover:border-teal/50 transition-colors">
          Start Over
        </button>
      </header>
